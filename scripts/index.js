...
let profileNameInput = document.querySelector(".popup__container_form-input_name");
let editForm = document.querySelector("#form");
let profileDescription = document.querySelector(".profile__info_description");
let profileDescriptionInput = document.querySelector(".popup__container_form-input_description");
